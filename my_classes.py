...
class Person:
    ...
    def put(self):
        ...
        if response.status_code == 201:
            print("Person successfully created on the server.")
        else:
            print("Failed to create person on the server.")
...
class Subject(Person):
    ...
    def update_email(self):
        ...
        response = requests.put(f"http://127.0.0.1:5000/person/{self._first_name}", json=data)
